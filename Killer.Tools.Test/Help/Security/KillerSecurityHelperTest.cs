...
namespace Killer.Tools.Test.Help.Security
{
    ...
    public class KillerSecurityHelperTest
    {
        ...
        {
            string str = "123";
            var res = KillerHashSecurityHelper.Md5Encryption(str);
        ...
        {
            string str = "123";
            var res = KillerHashSecurityHelper.Sha1Encryption(str);
        ...
        {
            string str = "12300";
            var res = KillerHashSecurityHelper.Sha224Encryption(str);
            Console.WriteLine(res);
